...
import { Mail, Phone, User as UserIcon, Calendar, MapPin } from 'lucide-react';
...
export default function ProfilePage() {
    ...
    // Fetch profile if not already available (or to refresh)
    // Optionally check if token exists, but let's assume we are protected or handle 401
    useEffect(() => {
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                        <h2 className="text-lg font-semibold text-gray-900 mb-4 flex items-center gap-2">
                            <UserIcon className="h-5 w-5 text-gray-400" /> Personal Information
                        </h2>
