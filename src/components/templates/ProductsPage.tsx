...
import ItemDescriptionForm from "../organisms/products/ItemDescriptionForm";
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-50">
        <div className="text-center p-8 bg-white rounded-xl shadow-lg border border-slate-200 max-w-md">
          ...
          <p className="text-slate-600 mb-6"> We couldn&apos;t find the product you&apos;re looking for.</p>
      ...
      <form onSubmit={(e) => {
        ...
        <div className="border-b border-slate-200 bg-white shadow-sm sticky top-0 z-10">
          <div className="max-w-7xl mx-auto px-4 py-6 flex justify-between items-center">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">{item_id ? "Edit" : "Add"} Product</h1>
              <p className="mt-1 text-sm text-gray-600">  Enter product details, pricing, and variants</p>
            </div>
            <div className="flex gap-3">
              <Button type="button" variant="outline" onClick={handleOnClose}> Cancel</Button>
        ...
        <div className="max-w-7xl mx-auto px-4 py-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-8">
            ...
            {item_id && (
              <Section title="Detailed Description" subtitle="How it's made, usage, and specs">
                <ItemDescriptionForm formik={formik} />
              </Section>
            )}
          </div>
