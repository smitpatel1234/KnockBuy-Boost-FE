...
import type { DateInputPropsForDatePicker as DateInputProps  , DateParts} from '@/types/dateinput.types'

export const useDateRangePicker = ({value, onChange}: DateInputProps)=>{
